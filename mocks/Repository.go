...
func (_m *Repository) GetAll() ([]models.BlogPost, error) {
	ret := _m.Called()
...
func (_m *Repository) GetByID(id uint) (*models.BlogPost, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Update(id uint, post *models.BlogPost) error {
